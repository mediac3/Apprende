...
export const GRADES_TABLE_DEFAULTS = {
  ...
  studentNameAlign: "left",
  studentNameColor: "", // "" = heredado (comportamiento actual)
  rowDensity: "normal",
  headerHeight: 40,
  minColumnWidth: 180,
...
const gradesTableSchema = z
  .object({
    ...
    studentNameAlign: z.enum(["left", "center", "right"]).catch("left"),
    studentNameColor: hexColor,
  ...
  .catch({
    ...
    studentNameAlign: "left" as const,
    studentNameColor: "",
